...
Pada panel bagian `DEBUG CONSOLE` pada panel VSCode. Terdapat stack tracing, pergi ke stack paling atas agar lebih informatif. Selain itu, bagian ini bisa menyimpan hasil `print()`
